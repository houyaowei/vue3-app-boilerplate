<template>
  <div class="sv-box" :style="{ width: w + 'px' }" onselectstart="return false">
    ...
    <canvas :width="w" :height="h" ref="block" class="canvas-block"> </canvas>
    <!-- 滑动条容器 -->
    <div
      class="slider"
      :class="{
...
const sliderDown = (e) => {
  ...
  console.log("sliderDown", e.clientX, e.clientY);
};
...
.sv-box {
  ...
  .sv-refresh {
    ...
    height: 34px;
    cursor: pointer;
    background: url("@/assets/image/icons-sprite.png");
